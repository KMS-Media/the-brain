# 🧠 the_brain — Developer & Architecture Guide

> Building or hacking on the plugin? You're in the right place. **Just want to
> install and use it?** See [README.md](./README.md).
